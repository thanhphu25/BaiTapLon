...
bool SDLCommonFunc::LoadSaveFile(int& px_pos, int& py_pos, int& p_heath, int& p_money, int& time_)
{
...
bool SDLCommonFunc::SaveGame(const int& px_pos, const int& py_pos, const int& p_heath, const int& p_money, const int& time_)
{
